...
public class add_product_via_seller extends login.openselenium{
  @Test(dataProviderClass=data_provider.z_data_provider.class,dataProvider="add_product_via_seller")
public static void test_add_product_via_seller(String data) throws InterruptedException, IOException 
  {
	  int user_type=0; //for admin user_type=1 and for seller user_type=0
